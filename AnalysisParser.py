...
clinvar_trait = the trait/disease the clinvar_clnsig referring to
    ...
    button_close.place(x=700, y=780)
...
table.pack(padx=10, pady=20, ipadx=1200, ipady=150)
...
text_SearchID = tk.Text(root, width=15, height=1, font=('tahoma', 8), wrap='none')
text_SearchID.place(x=20, y=400)
text_SearchID.delete('1.0', tk.END)
...
text_reason_for_inclusion_postParsing = tk.Text(root, width=35, height=1, font=('tahoma', 8), wrap='none')
...
text_filt_freq = tk.Text(root, width=22, height=1, font=('tahoma', 8), wrap='none')
text_filt_freq.place(x=880, y=y_origin+i*gain)
label_filt_freq=tk.Label(root, text='filt_freq:', font=('tahoma', 8))
label_filt_freq.place(x=880,y=y_origin+i*gain-25)

text_filt_alt_count = tk.Text(root, width=22, height=1, font=('tahoma', 8), wrap='none')
text_filt_alt_count.place(x=1060, y=y_origin+i*gain)
label_filt_alt_count=tk.Label(root, text='filt_alt_count:', font=('tahoma', 8))
label_filt_alt_count.place(x=1060,y=y_origin+i*gain-25)

text_filt_total_count = tk.Text(root, width=22, height=1, font=('tahoma', 8), wrap='none')
text_filt_total_count.place(x=1240, y=y_origin+i*gain)
label_filt_total_count=tk.Label(root,text='filt_total_count:', font=('tahoma', 8))
label_filt_total_count.place(x=1240,y=y_origin+i*gain-25)

text_filt_db_name = tk.Text(root, width=15, height=1, font=('tahoma', 8), wrap='none')
text_filt_db_name.place(x=1420, y=y_origin+i*gain)
label_filt_db_name=tk.Label(root, text='filt_db_name:', font=('tahoma', 8))
label_filt_db_name.place(x=1420,y=y_origin+i*gain-25)
...
text_ExonicFunc__refGene.place(x=630, y=y_origin+i*gain)
label_ExonicFunc__refGene=tk.Label(root, text='ExonicFunc:', font=('tahoma', 8))
label_ExonicFunc__refGene.place(x=630,y=y_origin+i*gain-25)

text_AAChange__refGene = tk.Text(root, width=115, height=3, font=('tahoma', 8))
text_AAChange__refGene.place(x=785, y=y_origin+i*gain)
label_AAChange__refGene=tk.Label(root, text='AAChange:', font=('tahoma', 8))
label_AAChange__refGene.place(x=785,y=y_origin+i*gain-25)
...
text_ExonicFunc__knownGene.place(x=630, y=y_origin+i*gain+half)

text_AAChange__knownGene = tk.Text(root, width=115, height=3, font=('tahoma', 8))
text_AAChange__knownGene.place(x=785, y=y_origin+i*gain+half)

y_origin = 650
gain = 65
i = 0

text_geneDisease_annotation = tk.Text(root, width=85, height=4, font=('tahoma', 8))
...
text_HGMD_mutations_nearby = tk.Text(root, width=80, height=4, font=('tahoma', 8))
text_HGMD_mutations_nearby.place(x=630, y=y_origin+i*gain)
label_HGMD_mutations_nearby=tk.Label(root,text='HGMD_mutations_nearby:', font=('tahoma', 8))
label_HGMD_mutations_nearby.place(x=630,y=y_origin+i*gain-25)

text_retinaSpecific_exon = tk.Text(root, width=10, height=1, font=('tahoma', 8), wrap='none')
text_retinaSpecific_exon.place(x=1190, y=y_origin+i*gain)
label_retinaSpecific_exon=tk.Label(root,text='retinaSpecific_exon:', font=('tahoma', 7))
label_retinaSpecific_exon.place(x=1190,y=y_origin+i*gain-25)

text_variant_exceptions_list = tk.Text(root, width=10, height=1, font=('tahoma', 8), wrap='none')
text_variant_exceptions_list.place(x=1300, y=y_origin+i*gain)
label_variant_exceptions_list=tk.Label(root,text='variant_exceptions_list:', font=('tahoma', 7))
label_variant_exceptions_list.place(x=1300,y=y_origin+i*gain-25)

text_ada_score = tk.Text(root, width=15, height=1, font=('tahoma', 8), wrap='none')
text_ada_score.place(x=1400, y=y_origin+i*gain)
label_ada_score=tk.Label(root,text='ada_score:', font=('tahoma', 8))
label_ada_score.place(x=1400,y=y_origin+i*gain-25)

text_rf_score = tk.Text(root, width=8, height=1, font=('tahoma', 8), wrap='none')
text_rf_score.place(x=1520, y=y_origin+i*gain)
label_rf_score=tk.Label(root,text='rf_score:', font=('tahoma', 8))
label_rf_score.place(x=1520,y=y_origin+i*gain-25)
...
text_Interpro_domain = tk.Text(root, width=80, height=2, font=('tahoma', 8))
...
text_clinvar_trait = tk.Text(root, width=30, height=2, font=('tahoma', 8), wrap='none')
